...
A simple quotes application built using modern android development tools (kotlin, jetpack compose,
mvvm, retrofit, flow, coroutines, workManager)
...
![Daily Quote](/docs/images/DailyQuote.jpeg)

(/docs/images/DailyQuote.jpeg "All notes")