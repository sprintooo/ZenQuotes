...
import com.himanshu.androidbasics.di.module.NetworkingModule;
import com.himanshu.androidbasics.di.module.NetworkingModule_ProvideQuoteServiceFactory;
import com.himanshu.androidbasics.di.module.NetworkingModule_ProvideRetrofitFactory;
...
public final class DaggerAndroidApplication_HiltComponents_SingletonC {
  ...
  public static AndroidApplication_HiltComponents.SingletonC create() {
  ...
  public static final class Builder {
    ...
    public Builder networkingModule(NetworkingModule networkingModule) {
      this.networkingModule = Preconditions.checkNotNull(networkingModule);
      return this;
    }
    ...
    public AndroidApplication_HiltComponents.SingletonC build() {
      ...
      return new SingletonCImpl(networkingModule);
    }
  }
  ...
  private static final class ActivityCImpl extends AndroidApplication_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_himanshu_androidbasics_MainViewModel, MainViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_himanshu_androidbasics_MainViewModel = "com.himanshu.androidbasics.MainViewModel";

      @KeepFieldType
      MainViewModel com_himanshu_androidbasics_MainViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends AndroidApplication_HiltComponents.ViewModelC {
    ...
    private QuoteRepository quoteRepository() {
      return new QuoteRepository(singletonCImpl.quoteService());
    }
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_himanshu_androidbasics_MainViewModel, ((Provider) mainViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.himanshu.androidbasics.MainViewModel 
          return (T) new MainViewModel(viewModelCImpl.quoteRepository());
  ...
  private static final class SingletonCImpl extends AndroidApplication_HiltComponents.SingletonC {
    private final NetworkingModule networkingModule;

    private final SingletonCImpl singletonCImpl = this;

    private SingletonCImpl(NetworkingModule networkingModuleParam) {
      this.networkingModule = networkingModuleParam;

    }

    private QuoteService quoteService() {
      return NetworkingModule_ProvideQuoteServiceFactory.provideQuoteService(networkingModule, NetworkingModule_ProvideRetrofitFactory.provideRetrofit(networkingModule));
    }

    @Override
    public void injectAndroidApplication(AndroidApplication arg0) {
    }
